...
public class ModBlocks {
    ...
    public static final Block TOY_BRICKS_WALL = registerBlock("toy_bricks_wall", properties -> new WallBlock(properties.strength(TOY_BRICK_HARDNESS,TOY_BRICK_RESISTANCE).sounds(ModSounds.TOY_BRICKS).mapColor(MapColor.YELLOW)));
    ...
    public static final Block CASTLE_TOY_BRICKS_WALL = registerBlock("castle_toy_bricks_wall", properties -> new WallBlock(properties.strength(TOY_BRICK_HARDNESS,TOY_BRICK_RESISTANCE).sounds(ModSounds.TOY_BRICKS).mapColor(MapColor.STONE_GRAY)));
    ...
    public static final Block MAGMA_TOY_BRICKS_WALL = registerBlock("magma_toy_bricks_wall", properties -> new WallBlock(properties.strength(TOY_BRICK_HARDNESS,TOY_BRICK_RESISTANCE).sounds(ModSounds.TOY_BRICKS).mapColor(MapColor.BRIGHT_RED)));
    ...
    public static final Block PORTAL_TOY_BRICKS_WALL = registerBlock("portal_toy_bricks_wall", properties -> new WallBlock(properties.strength(TOY_BRICK_HARDNESS,TOY_BRICK_RESISTANCE).sounds(ModSounds.TOY_BRICKS).mapColor(MapColor.PURPLE)));
    //Dyed Toy Bricks
    ...
    public static final Block WHITE_TOY_BRICKS_WALL = registerBlock("white_toy_bricks_wall", properties -> new WallBlock(properties.strength(TOY_BRICK_HARDNESS,TOY_BRICK_RESISTANCE).sounds(ModSounds.TOY_BRICKS).mapColor(DyeColor.WHITE)));
    ...
    public static final Block LIGHT_GRAY_TOY_BRICKS_WALL = registerBlock("light_gray_toy_bricks_wall", properties -> new WallBlock(properties.strength(TOY_BRICK_HARDNESS,TOY_BRICK_RESISTANCE).sounds(ModSounds.TOY_BRICKS).mapColor(DyeColor.LIGHT_GRAY)));
    ...
    public static final Block GRAY_TOY_BRICKS_WALL = registerBlock("gray_toy_bricks_wall", properties -> new WallBlock(properties.strength(TOY_BRICK_HARDNESS,TOY_BRICK_RESISTANCE).sounds(ModSounds.TOY_BRICKS).mapColor(DyeColor.GRAY)));
    ...
    public static final Block BLACK_TOY_BRICKS_WALL = registerBlock("black_toy_bricks_wall", properties -> new WallBlock(properties.strength(TOY_BRICK_HARDNESS,TOY_BRICK_RESISTANCE).sounds(ModSounds.TOY_BRICKS).mapColor(DyeColor.BLACK)));
    ...
    public static final Block BROWN_TOY_BRICKS_WALL = registerBlock("brown_toy_bricks_wall", properties -> new WallBlock(properties.strength(TOY_BRICK_HARDNESS,TOY_BRICK_RESISTANCE).sounds(ModSounds.TOY_BRICKS).mapColor(DyeColor.BROWN)));
    ...
    public static final Block RED_TOY_BRICKS_WALL = registerBlock("red_toy_bricks_wall", properties -> new WallBlock(properties.strength(TOY_BRICK_HARDNESS,TOY_BRICK_RESISTANCE).sounds(ModSounds.TOY_BRICKS).mapColor(DyeColor.RED)));
    ...
    public static final Block ORANGE_TOY_BRICKS_WALL = registerBlock("orange_toy_bricks_wall", properties -> new WallBlock(properties.strength(TOY_BRICK_HARDNESS,TOY_BRICK_RESISTANCE).sounds(ModSounds.TOY_BRICKS).mapColor(DyeColor.ORANGE)));
    ...
    public static final Block YELLOW_TOY_BRICKS_WALL = registerBlock("yellow_toy_bricks_wall", properties -> new WallBlock(properties.strength(TOY_BRICK_HARDNESS,TOY_BRICK_RESISTANCE).sounds(ModSounds.TOY_BRICKS).mapColor(DyeColor.YELLOW)));
    ...
    public static final Block LIME_TOY_BRICKS_WALL = registerBlock("lime_toy_bricks_wall", properties -> new WallBlock(properties.strength(TOY_BRICK_HARDNESS,TOY_BRICK_RESISTANCE).sounds(ModSounds.TOY_BRICKS).mapColor(DyeColor.LIME)));
    ...
    public static final Block GREEN_TOY_BRICKS_WALL = registerBlock("green_toy_bricks_wall", properties -> new WallBlock(properties.strength(TOY_BRICK_HARDNESS,TOY_BRICK_RESISTANCE).sounds(ModSounds.TOY_BRICKS).mapColor(DyeColor.GREEN)));
    ...
    public static final Block CYAN_TOY_BRICKS_WALL = registerBlock("cyan_toy_bricks_wall", properties -> new WallBlock(properties.strength(TOY_BRICK_HARDNESS,TOY_BRICK_RESISTANCE).sounds(ModSounds.TOY_BRICKS).mapColor(DyeColor.CYAN)));
    ...
    public static final Block LIGHT_BLUE_TOY_BRICKS_WALL = registerBlock("light_blue_toy_bricks_wall", properties -> new WallBlock(properties.strength(TOY_BRICK_HARDNESS,TOY_BRICK_RESISTANCE).sounds(ModSounds.TOY_BRICKS).mapColor(DyeColor.LIGHT_BLUE)));
    ...
    public static final Block BLUE_TOY_BRICKS_WALL = registerBlock("blue_toy_bricks_wall", properties -> new WallBlock(properties.strength(TOY_BRICK_HARDNESS,TOY_BRICK_RESISTANCE).sounds(ModSounds.TOY_BRICKS).mapColor(DyeColor.BLUE)));
    ...
    public static final Block PURPLE_TOY_BRICKS_WALL = registerBlock("purple_toy_bricks_wall", properties -> new WallBlock(properties.strength(TOY_BRICK_HARDNESS,TOY_BRICK_RESISTANCE).sounds(ModSounds.TOY_BRICKS).mapColor(DyeColor.PURPLE)));
    ...
    public static final Block MAGENTA_TOY_BRICKS_WALL = registerBlock("magenta_toy_bricks_wall", properties -> new WallBlock(properties.strength(TOY_BRICK_HARDNESS,TOY_BRICK_RESISTANCE).sounds(ModSounds.TOY_BRICKS).mapColor(DyeColor.MAGENTA)));
    ...
    public static final Block PINK_TOY_BRICKS_WALL = registerBlock("pink_toy_bricks_wall", properties -> new WallBlock(properties.strength(TOY_BRICK_HARDNESS,TOY_BRICK_RESISTANCE).sounds(ModSounds.TOY_BRICKS).mapColor(DyeColor.PINK)));
